...
[WATCH THIS CARD AS A VIDEO.](https://youtu.be/GT3Mu3OTtBY)
...
See [Threshold Guardians](http://www.apocprod.com/Pages/Hero/Hero_Diagram_Pages/threshold_guardian.htm) for a discussion of this archetype and examples from popular culture and classical myths.

*

In the epilogue of my sci-fi epic, Parallel Journeys*, I describe a series of improbable mishaps during a road trip that had me wondering if my threshold guardian interpretation would hold up. It did, and it exemplified the principle that the bigger the dragon, the larger the pearl of great price it guards. [*Parallel Journeys*](https://zaporacle.com/parallel-journeys-start-page/), can be read free on this site. If you prefer Audible, Kindle or physical versions, those are [all available on Amazon.](https://www.amazon.com/s?k=parallel+journeys+jonathan+zap&crid=3QBGAL48DF5JW&sprefix=parallel+journeys%2Caps%2C160&ref=nb_sb_ss_ts-doa-p_4_17)
