...
![[4451-scaled-e1704247808501.jpg]]

[WATCH THIS CARD AS A VIDEO](https://youtu.be/gTo3WYmOgOU)

Every new technology cuts both ways. Value the tools you need to use, but be careful about becoming obsessed with them. As Sophocles said, no great gift enters the human sphere without a curse. Use the technology, but be careful about it using you.
...
It is crucial that you be the one using the magic rather than letting it use you. For technology to be magic, you must be using it to create change in conformity to your will. When technology creates change not in conformity to your will, it is an environmental condition like wind, rain, or earthquake. 

Technology can hollow us out if it supplants our inner development of magic. We should appreciate the great value it can provide but also not completely take it for granted. One[super solar flare](http://science.nasa.gov/science-news/science-at-nasa/2008/06may_carringtonflare/) pointed in the right direction could wipe out all non-hardened electronics across a hemisphere. This is not an exceptionally rare phenomenon, and its occurrence is not a question of if, but when.
...
AI is already changing everything, everywhere, all at once, but its vast alteration of the human experience is exponential. I urge you to read (or watch the YouTube version) of [AI, the Singularity Archetype and the High Probability of an Impending Viral Apocalypse](https://zaporacle.com/ai-the-singularity-archetype-and-the-high-possibility-of-an-impending-viral-apocalypse/). It's based on my work on the Singularity Archetype, which began in 1978, and it includes perspectives on AI you will not find elsewhere.
